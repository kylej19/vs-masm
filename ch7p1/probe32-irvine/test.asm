...
.data                               ;data
;----------------------------------------
title1 BYTE "Exercise #1",0dh,0ah,"-------------",0dh,0ah,0
title2 BYTE "Exercise #2",0dh,0ah,"-------------",0dh,0ah,0
title3 BYTE "Exercise #3",0dh,0ah,"-------------",0dh,0ah,0
title4 BYTE "Exercise #4",0dh,0ah,"-------------",0dh,0ah,0
title5 BYTE "Exercise #5",0dh,0ah,"-------------",0dh,0ah,0
msg1a BYTE "AX= ",0
msg1b BYTE "EAX= ",0
msg2 BYTE "AL= ",0
msg3 BYTE "AX= ",0
...
;----------------------------------------
    ...
    mov edx,offset msg4
    call writestring                ;display a message
    xor edx,edx                     ;clear the upper half of our dividend
...
L1:
    xor eax,eax                 ;clear out eax
    shrd eax,edx,4              ;shift the upper nybble 
    or al,30h
    mov byte ptr [edi],al
    add edi,type buffer
    loop L1
